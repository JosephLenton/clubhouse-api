...
pub struct EpicStats {
  ...
  pub num_points : u32,
  pub num_points_done : u32,
  pub num_points_started : u32,
  pub num_points_unstarted : u32,
  pub num_stories_done : u32,
  pub num_stories_started : u32,
  pub num_stories_unestimated : u32,
  pub num_stories_unstarted : u32,
}

#[derive(Clone, Deserialize, Serialize, Debug)]
pub struct EpicWorkflow {
  pub created_at : DateTime<Utc>,
  pub default_epic_state_id : u32,
  pub entity_type : String,
...
pub struct LabelStats {
  pub num_epics : u32,
  pub num_points_completed : u32,
  pub num_points_in_progress : u32,
  pub num_points_total : u32,
  pub num_stories_completed : u32,
  pub num_stories_in_progress : u32,
  pub num_stories_total : u32,
  pub num_stories_unestimated : u32,
}
...
pub struct CreateProject {
  ...
  pub external_id : Option<String>,
  pub follower_ids : Option<Vec<Uuid>>,
  pub iteration_length : Option<u32>,
  pub name : String,
...
pub struct UpdateProject {
  ...
  pub archived : Option<bool>,
  pub color : Option<String>,
  pub days_to_thermometer : Option<u32>,
  pub description : Option<String>,
  pub follower_ids : Option<Vec<Uuid>>,
  pub name : Option<String>,
...
pub struct CreateStory {
  ...
  pub estimate : Option<u32>,
  pub external_id : Option<String>,
  pub file_ids : Option<Vec<u32>>,
  pub follower_ids : Option<Vec<Uuid>>,
  pub labels : Option<Vec<CreateLabelParams>>,
  pub linked_file_ids : Option<Vec<u32>>,
  pub name : String,
  pub owner_ids : Option<Vec<Uuid>>,
  pub project_id : u32,
  pub requested_by_id : Option<Uuid>,
  ...
  pub updated_at : Option<DateTime<Utc>>,
  pub workflow_state_id : Option<u32>,
}
...
pub struct UpdateStory {
  ...
  pub archived : Option<bool>,
  pub before_id : Option<u32>,
  pub branch_ids : Option<Vec<u32>>,
  pub commit_ids : Option<Vec<u32>>,
  pub completed_at_override : Option<DateTime<Utc>>,
  pub deadline : Option<DateTime<Utc>>,
  pub description : Option<String>,
  pub epic_id : Option<u32>,
