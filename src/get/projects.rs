...
impl ClubhouseGetProject {
  pub fn project_public_id(self, project_public_id : String) -> self::project_public_id::ClubhouseGetProjectProjectPublicId {
  ...
  pub fn run(self) -> burgundy::Result<Vec<crate::types::Project>> {
    self.path
        .execute_as_json::<Vec<crate::types::Project>>()
  }
}
