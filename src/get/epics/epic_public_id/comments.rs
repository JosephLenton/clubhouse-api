...
impl ClubhouseGetEpicEpicPublicIdComment {
  pub fn comment_public_id(self, comment_public_id : String) -> self::comment_public_id::ClubhouseGetEpicEpicPublicIdCommentCommentPublicId {
  ...
  pub fn run(self) -> burgundy::Result<Vec<crate::types::ThreadedComment>> {
    self.path
        .execute_as_json::<Vec<crate::types::ThreadedComment>>()
  }
}
