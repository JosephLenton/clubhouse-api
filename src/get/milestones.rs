...
impl ClubhouseGetMilestone {
  pub fn milestone_public_id(self, milestone_public_id : String) -> self::milestone_public_id::ClubhouseGetMilestoneMilestonePublicId {
  ...
  pub fn run(self) -> burgundy::Result<Vec<crate::types::Milestone>> {
    self.path
        .execute_as_json::<Vec<crate::types::Milestone>>()
  }
}
